...
public class Main extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_venda) {
            ...
            Intent i = new Intent(Main.this, ActivityVenda.class);
            startActivity(i);
        ...
        } else if (id == R.id.nav_trocaProduto) {

        } else if (id == R.id.nav_relatorio_cliente) {

        } else if (id == R.id.nav_relatorio_produto) {

        } else if (id == R.id.nav_relatorio_venda) {

        } else if (id == R.id.nav_relatorio_pagamento) {
